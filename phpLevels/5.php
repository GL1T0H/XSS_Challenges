...
$xss = $_GET['xss'];
$finder = preg_match_all('#(confirm|alert|prompt)#i', $xss);
$src = "../robotvideo.mp4";
$type = "video/mp4";
$ed = 400;
if($finder) {
    ...
    echo "<font color=white><h2>Hint: Do not repeat the code</h2></font>";
    echo "<video controls width=$ed hight=$ed><source src='$src".$xss."' type=$type /></video>";
